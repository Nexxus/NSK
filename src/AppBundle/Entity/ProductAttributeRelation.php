...
class ProductAttributeRelation
{
     ...
     *
     * @ORM\Id
     * @ORM\ManyToOne(targetEntity="Product", inversedBy="attributeRelations")
    ...
    {
        if ($this->getAttribute()->getType() != Attribute::TYPE_PRODUCT || !$this->getAttribute()->getHasQuantity() || $this->quantity === null)
            return 1;
