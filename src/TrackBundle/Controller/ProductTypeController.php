...
class ProductTypeController extends Controller
{
    ...
    public function indexAction() 
    {
        ...
        return $this->render('TrackBundle:Type:index.html.twig', 
    ...
    public function createAction(Request $request)
    {
        ...
        {
            return $this->render('TrackBundle:Type:new.html.twig', array(
    ...
    public function showAction($id)
    {
        ...
        return $this->render('TrackBundle:Type:show.html.twig', array(
    ...
    public function editAction(ProductType $producttype, Request $request)
    {
        ...
        return $this->render('TrackBundle:Type:edit.html.twig', array(
