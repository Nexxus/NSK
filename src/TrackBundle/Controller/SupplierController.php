...
use TrackBundle\Form\SupplierType;
...
class SupplierController extends Controller
{
    ...
    {
        $repo = $this->getDoctrine()->getRepository('TrackBundle:Supplier');
        ...
        return $this->render('TrackBundle:Supplier:index.html.twig', array(
    ...
    public function editAction(Request $request, $id)
    {
        ...
        {
            $supplier = $em->getRepository('TrackBundle:Supplier')->find($id);
        }
        ...
        return $this->render('TrackBundle:Supplier:edit.html.twig', array(
                'form' => $form->createView(),
            ));
    }
