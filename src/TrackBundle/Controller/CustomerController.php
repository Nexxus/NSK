...
use TrackBundle\Form\CustomerType;
...
class CustomerController extends Controller
{
    ...
    {
        $repo = $this->getDoctrine()->getRepository('TrackBundle:Customer');
        ...
        return $this->render('TrackBundle:Customer:index.html.twig', array(
    ...
    public function editAction(Request $request, $id)
    {
        ...
        {
            $customer = $em->getRepository('TrackBundle:Customer')->find($id);
        }
        ...
        return $this->render('TrackBundle:Customer:edit.html.twig', array(
                'customer' => $customer,
                'form' => $form->createView(),
            ));
    }
