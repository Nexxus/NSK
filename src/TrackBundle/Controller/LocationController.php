...
class LocationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('TrackBundle:Location:index.html.twig', array(
            'locations' => $locations,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('TrackBundle:Location:new.html.twig', array(
            'location' => $location,
    ...
    public function showAction(Location $location)
    {
        ...
        return $this->render('TrackBundle:Location:show.html.twig', array(
            'location' => $location,
    ...
    public function editAction(Request $request, Location $location)
    {
        ...
        return $this->render('TrackBundle:Location:edit.html.twig', array(
            'location' => $location,
